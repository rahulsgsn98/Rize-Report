...
test('Verify date time displays or not correctly after click on the Biz-Dev Funded link', async ({ page }) => {
...
await bizDevFundedPage.waitForRefreshDateTimeToBeVisible();

const isRefreshDateTimeDisplayed = await bizDevFundedPage.isRefreshDateTimeDisplayed();
